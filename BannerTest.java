...
public class Program4{
	...
	public static void main(String[] args){
		...
		try{
			...
			System.out.printf("The total price of Curved Banner is %.3f%n",compute(ban1,copies));
		}
		catch(IllegalDiamensionException e){
			System.out.printf("You have Entered wrong Diamension.%n Thank you for visiting!! %n Come Again.%n");
		}
	}
}
